...
def describe_game(name):
    """
        ...
        check if this is a game or not.
...
def win(nice,mean,name):
    ...
    print("\nNice job {}, you win!  \nYou smell of rich mahogany \nand leather-bound books!".format(name))
    # call again function and pass in our variables
    again(nice,mean,name)


def lose(nice,mean,name):
    # Substitute th {} wildcards with our variables values
    print("\nAhhh too bad, game over!  \n{}, you live in a dirty beat-up \nvan by the river, wretched and alone, you mean troll!".format(name))
    # call again function and pass in our variables
    again(nice,mean,name)
